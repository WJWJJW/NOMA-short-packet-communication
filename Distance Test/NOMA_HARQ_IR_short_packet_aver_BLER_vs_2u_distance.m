...
semilogy(D1, epsilon2,'or'); hold on; grid on;
semilogy(D1, epsilon1, 'ob');
semilogy(D1, epsilon12,'og');
semilogy(D1, epsilon11, 'ok');

semilogy(D1, MAT_Epsilon2,'r', 'linewidth',1.5);
semilogy(D1, MAT_Epsilon1, 'b','linewidth',1.5);
semilogy(D1, MAT_Epsilon12,'g', 'linewidth',1.5);
semilogy(D1, MAT_Epsilon11, 'k','linewidth',1.5);

semilogy(D1, epsilon2_high_SNR,'*r');
semilogy(D1, epsilon1_high_SNR, '*b');
semilogy(D1, epsilon12_high_SNR,'*g');
semilogy(D1, epsilon11_high_SNR, '*k');

title('BLER vs Distance');
xlabel('User1 distance (in meter)');
ylabel('BLER');
