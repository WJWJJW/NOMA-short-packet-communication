...
%                1e-4 1e-4 1e-4 1e-4 1e-4];
target_BLER = [1e-6 1e-6 1e-6 1e-6 1e-6 ...
...
ret1 = [EP_e_delay_user_ave(:,1) EP_e_delay_user_ave(:,2) ...
 ...
 legend('EP w/o HARQ', 'EP w/ HARQ',...
        'RP w/o HARQ', 'RP w/ HARQ',...
        'NLUPA w/o HARQ', 'NLUPA w/ HARQ',...
        'SAP w/o HARQ', 'SAP w/ HARQ',...
        'UPG w/o HARQ', 'UPG w/ HARQ',...
        'HAP w/o HARQ', 'HAP w/ HARQ',...
        'OMA w/o HARQ', 'OMA w/ HARQ');
...
yline(35616,'-','HandleVisibility','off');
