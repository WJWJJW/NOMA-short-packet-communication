% Enhanced Hungarian Algorithm Pairing (return size of RG)
function [sum_opt_M, opt_M, Hungarian_pairing, size_RG]=En_HAP_return_RG(user_distance, N, K, target_BLER, rho, eta, lamda)
    user_idx = 1:2*K;
    UPG_idx = zeros(K,2);
    ...
    size_RG = size(re_pairing_idx_check(re_pairing_idx_check==1),1);
